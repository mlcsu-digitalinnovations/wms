...
namespace WmsHub.Referral.Api.Controllers
{
  ...
  public class TestController : BaseController
  {
    ...
    /// <summary>
    /// Posts a referral to the WmsHub ready for the rmc call
    /// creating two associated text messages 144 and 192 hours in the past
    /// and two associated chat bot calls 48 and 96 hours in the past
    /// </summary>
    /// <param name="referralPost"></param>
    /// <response code="200">Referral created</response>
    /// <response code="400">Missing/invalid values</response>
    ...
    [Consumes("application/json")]
    [Route("Referral/Rmc")]
    public async Task<IActionResult> PostRmcStatus
      ([FromBody] ReferralPost referralPost)
    {
      try
      {
        IReferralCreate referralCreate =
           _mapper.Map<ReferralCreate>(referralPost);
        IReferral response =
          await Service.TestCreateWithRmcStatus(referralCreate);
