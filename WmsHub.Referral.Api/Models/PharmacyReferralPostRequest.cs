...
namespace WmsHub.Referral.Api.Models
{
  public class PharmacyReferralPostRequest
  {
    ...
    private string _referringPharmacyOdsCode;
    public string ReferringPharmacyOdsCode {
      get => _referringPharmacyOdsCode;
      set {
        _referringPharmacyOdsCode = string.IsNullOrEmpty(value) 
          ? value 
          : value.Trim().ToUpper();
      } 
    }
