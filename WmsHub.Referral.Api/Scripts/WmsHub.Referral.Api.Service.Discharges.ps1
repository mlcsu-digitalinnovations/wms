...
$subject = "WmsHub.Referral.Api.Service.Discharges"
$body = "The WmsHub.Referral.Api.Service.Discharges"
$mailPriority = 0

$app = "WmsHub.Referral.Api.Service.Discharges.Daily"
...
try
{
    ...
    $Params = @{
     "URI"     = "https://api-referrals.wmp.nhs.uk/admin/preparedischarges"
     "Method"  = 'GET'
     "Headers" = @{
