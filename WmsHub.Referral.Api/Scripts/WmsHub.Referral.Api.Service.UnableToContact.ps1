...
$subject = "WmsHub.Referral.Api.UnableToContact"
$body = "The WmsHub.Referral.Api.UnableToContact"
$mailPriority = 0
...
try
{
    ...
    $Params = @{
     "URI"     = "https://api-referrals.wmp.nhs.uk/admin/prepareunabletocontactreferrals"
     "Method"  = 'GET'
     "Headers" = @{
