...
$subject = "WmsHub.Referral.Api.Service.Delayed"
$body = "The WmsHub.Referral.Api.Service.Delayed"
$mailPriority = 0

$app = "WmsHub.Referral.Api.Service.Delayed.Daily"
...
try
{
    ...
    $Params = @{
     "URI"     = "https://api-referrals.wmp.nhs.uk/admin/preparedelayedcalls"
     "Method"  = 'GET'
     "Headers" = @{
