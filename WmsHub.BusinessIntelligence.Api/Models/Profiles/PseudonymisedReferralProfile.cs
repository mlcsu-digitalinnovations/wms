...
public class PseudonymisedReferralProfile : Profile
{
  public PseudonymisedReferralProfile()
  {
    CreateMap<Business.Models.PseudonymisedReferral, PseudonymisedReferral>()
