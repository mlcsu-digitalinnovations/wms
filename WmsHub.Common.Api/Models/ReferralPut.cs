...
namespace WmsHub.Common.Api.Models
{
  public class ReferralPut: IReferralTransformable
  {
    ...
    private long? _mostRecentAttachmentId;
    ...
    /// <summary>
    /// If MostRecentAttachmentId is set to null then the ReferralAttachmentId
    /// will be returned
    /// </summary>
    public long? MostRecentAttachmentId { 
      get => _mostRecentAttachmentId ?? ReferralAttachmentId; 
      set => _mostRecentAttachmentId = value; 
    }
