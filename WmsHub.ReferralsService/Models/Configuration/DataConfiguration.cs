...
namespace WmsHub.ReferralsService.Models.Configuration
{
  ...
  public class DataConfiguration
  {
    ...
    /// <summary>
    /// If set to TRUE, the smart card will be disconnected once the token
    /// has been retrieved in order to avoid session blocking when using a
    /// virtual smart card.
    /// </summary>
    public bool DisconnectSmartCardAfterUse { get; set; }
  }
}
