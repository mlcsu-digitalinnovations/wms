...
namespace WmsHub.Business.Services
{
    ...
    ServiceBase<Entities.PatientTriage>, IPatientTriageService
  {
    ...
    protected PatientTriageItems TriageItems
    {
      get
      {
        if (_triageItems != null) return _triageItems;
    ...
    public async Task<PatientTriageItemsResponse> GetAllTriageAsync()
    {
      PatientTriageItemsResponse response = new PatientTriageItemsResponse();
      response.Status = StatusType.Valid;
      try
      {
    ...
    public async Task<CourseCompletionResponse> GetAllCourseCompletionAsync()
    {
