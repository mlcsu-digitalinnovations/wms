...
namespace WmsHub.Business
{
  ...
  public class DatabaseContext : AuditDbContext
  {
    ...
    private static int TimesInitializeAzureKeyVaultProviderCalled = 0;
    ...
    private static string _alwaysEncryptedIsEnabled = Environment
    ...
    public virtual DbSet<ProviderRejectionReason> ProviderRejectionReasons
    { get; set; }
    public virtual DbSet<ProviderRejectionReasonAudit>
      ProviderRejectionReasonsAudit
    { get; set; }
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
      ...
      modelBuilder.Entity<TextMessage>()
        .Property(c => c.Number).HasMaxLength(200);
      modelBuilder.Entity<TextMessage>()
        .Property(r => r.Base36DateSent).HasMaxLength(20);
      modelBuilder.Entity<TextMessage>()
        .HasIndex(r => r.Base36DateSent)
        .IsUnique();
      ...
      SetGuidKeyOnId<ProviderRejectionReason>(modelBuilder);
      modelBuilder.Entity<ProviderRejectionReason>()
        .Property(t => t.Title).HasMaxLength(100);
      modelBuilder.Entity<ProviderRejectionReason>()
        .Property(t => t.Description).HasMaxLength(500);
      modelBuilder.Entity<ProviderRejectionReasonAudit>()
        .Property(t => t.Title).HasMaxLength(100);
      modelBuilder.Entity<ProviderRejectionReasonAudit>()
        .Property(t => t.Description).HasMaxLength(500);
      modelBuilder.Entity<ProviderRejectionReasonAudit>()
    ...
    {
      // thread-safe
      Interlocked.Increment(ref TimesInitializeAzureKeyVaultProviderCalled);

      if (TimesInitializeAzureKeyVaultProviderCalled == 1 &&
          (_alwaysEncryptedIsEnabled ?? "false").ToLower() != "false")
      {
