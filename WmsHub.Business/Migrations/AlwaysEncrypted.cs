...
namespace WmsHub.Business.Migrations
{
  ...
  public static class AlwaysEncrypted
  {
      ...
      MigrationBuilder migrationBuilder)
    {
      switch (migration)
      {
        ...
        case AlwaysEncryptedMigrations.MskReferral:
          ...
          break;
        case AlwaysEncryptedMigrations.GpReferral:
          GpReferralMigrationsColumns(migrationBuilder);
          break;
        case AlwaysEncryptedMigrations.ReferralQuestionnaire:
          ReferralQuestionnaireMigrationsColumn(migrationBuilder);
          break;
        case AlwaysEncryptedMigrations.MessagesQueue:
          MessageQueueMigrationsColumn(migrationBuilder);
          break;
        case AlwaysEncryptedMigrations.UdalExtract:
          UdalExtractMigrationsColumn(migrationBuilder);
          break;
      }
    }
    ...
    private static void GpReferralMigrationsColumns(
      MigrationBuilder migrationBuilder)
    {
      AlwaysEncryptedHelper.AddEncryptedColumnWithAudit(
        migrationBuilder, "dbo", "Referrals", "ErsUbrn",
        "[nvarchar](200)",
        EncryptionType.DETERMINISTIC, DatabaseContext.CEK, true);
    }

    private static void ReferralQuestionnaireMigrationsColumn(
      MigrationBuilder migrationBuilder)
    {
      AlwaysEncryptedHelper.AddEncryptedColumnWithAudit(
        migrationBuilder,
    ...
    private static void MessageQueueMigrationsColumn(
      MigrationBuilder migrationBuilder)
    {
      AlwaysEncryptedHelper.AddEncryptedColumn(
        migrationBuilder, "dbo", "MessagesQueue", "PersonalisationJson",
        "[nvarchar](4000)", EncryptionType.DETERMINISTIC, DatabaseContext.CEK,
        true);

      AlwaysEncryptedHelper.AddEncryptedColumn(
        migrationBuilder, "dbo", "MessagesQueue", "SendTo",
        "[nvarchar](200)", EncryptionType.DETERMINISTIC, DatabaseContext.CEK,
        true);
    }

    private static void UdalExtractMigrationsColumn(MigrationBuilder migrationBuilder)
    {
      AlwaysEncryptedHelper.AddEncryptedColumn(
        migrationBuilder, "dbo", "UdalExtracts", "DateOfBirth", "[datetimeoffset]",
        EncryptionType.RANDOMIZED, DatabaseContext.CEK, true);

      AlwaysEncryptedHelper.AddEncryptedColumn(
        migrationBuilder, "dbo", "UdalExtracts", "NhsNumber", "[nvarchar](200)",
        EncryptionType.DETERMINISTIC, DatabaseContext.CEK, true);

      AlwaysEncryptedHelper.AddEncryptedColumn(
        migrationBuilder, "dbo", "UdalExtracts", "ProviderUbrn", "[nvarchar](200)",
        EncryptionType.DETERMINISTIC, DatabaseContext.CEK, true);

      AlwaysEncryptedHelper.AddEncryptedColumn(
        migrationBuilder, "dbo", "UdalExtracts", "VulnerableDescription",
        "[nvarchar](max)", EncryptionType.RANDOMIZED, DatabaseContext.CEK, true);
    }
  }
}