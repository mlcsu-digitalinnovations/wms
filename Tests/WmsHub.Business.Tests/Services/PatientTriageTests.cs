...
namespace WmsHub.Business.Tests.Services
{
  ...
  public class PatientTriageServiceTests : ServiceTestsBase
  {
      ...
      if (_triageItem == null)
      {
        ...
        List<Entities.PatientTriage> items = new List<Entities.PatientTriage>
        {
          ...
          new Entities.PatientTriage
          {
            ...
            Value = 1,
            CheckSum = 2,
            Key = Enums.Sex.NotKnown.ToString()
          },
          new Entities.PatientTriage
          {
            Id = Guid.NewGuid(),
          ...
          new Entities.PatientTriage
          {
            ...
            Value = 1,
            CheckSum = 2,
            Key = Enums.Sex.NotSpecified.ToString()
          },
          new Entities.PatientTriage
          {
            Id = Guid.NewGuid(),
      ...
      List<ValueCompWeight> ages, bool areAgeValuesGroupEnums)
    {
      ...
      List<ValueCompWeight> ethnicities =
      [
        new(0,1,1),
        new(1,4,13),
        new(2,1,5),
      ...
      List<ValueCompWeight> deprivations =
      [
        new(0,4,6),
        new(1,2,4),
        new(2,2,4),
