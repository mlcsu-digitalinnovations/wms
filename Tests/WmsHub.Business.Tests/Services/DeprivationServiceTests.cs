...
namespace WmsHub.Business.Tests.Services
{
  ...
  public class DeprivationServiceTests : ServiceTestsBase
  {
    ...
    public DeprivationServiceTests(
    ...
    [Fact]
    public async void GetByLsoa_ArgumentNullException()
    {
    ...
    [Fact]
    public async void RefreshDeprivations_ArgumentNullException()
    {
      await Assert.ThrowsAsync<ArgumentNullException>(
