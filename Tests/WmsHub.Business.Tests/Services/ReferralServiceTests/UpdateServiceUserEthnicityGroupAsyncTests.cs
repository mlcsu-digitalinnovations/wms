  ...
  public partial class ReferralServiceTests : ServiceTestsBase
  {
      ...
      : ReferralServiceTests, IDisposable
    {
      ...
      private readonly string _ethnicityNotFoundException =
        ...
        "be found.";
      private readonly string _bmiTooLowException =
        "A referral that has the ethnicity group {ethnicityGroup} needs a " +
        "BMI greater than {minimumBmi} but this referral has a BMI of {bmi}.";
