...
namespace WmsHub.Business.Tests.Services
{
  public partial class ReferralServiceTests : ServiceTestsBase
  {
    public class SetBmiTooLowAsyncTests : ReferralServiceTests, IDisposable
    {
      ...
      {
        // arrange
        var ethnicity = RandomEntityCreator.CreateRandomEthnicity(
          isActive: false,
      ...
      public async Task Valid()
      {
        ...
        Entities.Referral createdReferral = RandomEntityCreator.CreateRandomReferral(
        ...
        // act
        Business.Models.IReferral result = await _service.SetBmiTooLowAsync(createdReferral.Id);
