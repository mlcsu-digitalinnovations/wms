...
namespace WmsHub.Business.Tests.Services
{
  ...
  public class ProviderServiceTests : ServiceTestsBase
  {
    ...
    public ProviderServiceTests(ServiceFixture serviceFixture,
    ...
    private Guid AddFakeReferral(string ubrn, Guid providerId,
    ...
    public class GetServiceUsers : ProviderServiceTests
    {
      ...
      public async Task ForEachType()
      {
          ...
          in Enum.GetValues(typeof(ReferralStatus)))
        {
          ...
          //Act
          IEnumerable<ServiceUser> results =
            await _service.GetServiceUsers();
    ...
    public class AddProviderSubmissionsAsyncTests : ProviderServiceTests
    {      
      private Guid _providerId = default(Guid);
      private Guid _referralIdToTest = default(Guid);
      ...
      public async Task ProviderCompleted_NotGpReferralSource_Complete(
          ReferralSource referralSource)
      {
        ...
        var serviceUserSubmissionRequest = new ServiceUserSubmissionRequest()
        {
          Date = DateTimeOffset.Now,
          Type = UpdateType.Completed.ToString(),
          Ubrn = ProviderServiceTests._ubrn
        };

        var providerSubmissionRequest = new ProviderSubmissionRequest(
        ...
        //clean up
        _context.Referrals.Remove(_referral);
        await RemoveFakeProvider(Guid.Parse(TEST_USER_ID));
        await _context.SaveChangesAsync();
      }

      [Fact]
      public async Task ProviderCompleted_GpReferralSource_ProviderCompleted()
      {
        // arrange
        _referral.Status = ReferralStatus.ProviderStarted.ToString();
        _referral.ReferralSource = ReferralSource.GpReferral.ToString();
        _context.SaveChanges();
      ...
      public async Task ProviderAcceptedAllowed_NullException()
      {
        ...
        ProviderSubmissionRequest request =
          new ProviderSubmissionRequest(requests[0], Guid.Parse(TEST_USER_ID),
            _referralIdToTest);
      ...
      public async Task ProviderAcceptedExpectedException(ReferralStatus status)
      {
        //Arrange
        ...
        try
        {
          bool results =
            ...
            _referralIdToTest);
          //Assert
          Assert.True(false, "StatusChangeException expected");
        }
      ...
      public async Task ProviderAcceptedAllowed()
      {
        ...
        //Act
        bool results =
          await _service.AddProviderSubmissionsAsync(request, _referralIdToTest);
        //Assert
        ...
        ReferralSource referralSource, ReferralStatus expectedStatus)
      {
        ...
        ProviderSubmissionRequest request = new ProviderSubmissionRequest(
          requests[0], Guid.Parse(TEST_USER_ID), _referralIdToTest);
    ...
    public class SubmissionTests : ProviderServiceTests
    {
      ...
      public async Task UpdateTypeUpdateInvalidReferralStatus(
        string status)
      {
        // arrange
        var ubrn = "824514414411";
      ...
      [Theory]
      [MemberData(nameof(ReferralStatusStrings))]
      public async Task UpdateTypeUpdateInvalidReferralStatusIgnored(
        string status)
      {
        // arrange
        var ubrn = "824514414411";
      ...
      public async Task ReferralIdNotFoundUsingUbrn_InvalidStatus()
      {
        ...
        var providerName = _context.Providers
          ...
          .Select(p => p.Name)
          .Single();
        string error = $"UBRN {ubrn} for provider {providerName} not found.";
        IEnumerable<ServiceUserSubmissionRequest> requests =
          new List<ServiceUserSubmissionRequest>
          {
            new ServiceUserSubmissionRequest
      ...
      public async Task AddSubmissionLate_Invalid()
      {
        ...
        var expectedErrorStart =
          $"UBRN {ubrn} for provider {_providerName} Date Of Provider " +
      ...
      [InlineData(ValidTestModels.SubmissionComplete1
        ...
        "UBRN {0} for provider {1} cannot accept some of the update dates " +
      ...
      [InlineData(InvalidTestModels.SubmissionRejectedMissingReason
        , Enums.StatusType.Invalid,
        "UBRN {0} for provider {1} The Reason field '' is invalid..")]
        ...
        Enums.StatusType status, string error)
      {
        ...
        foreach (ServiceUserSubmissionRequest request in requests)
        {
          if (status == StatusType.Invalid)
          {
            ...
            if (entity == null)
              Assert.True(false,
                $"Enitity for UBRN {request.Ubrn} Not found for testing");
            ...
            if (string.IsNullOrWhiteSpace(expectedError))
              expectedError = string.Format(error,
                entity.Ubrn,
                entity.ProviderId);
          }
    ...
    public class UpdateProviderAuthAsyncTests : ProviderServiceTests
    {
      ...
      [Fact]
      public async Task Validate_ProviderAuthUpdateRequest_ip_IsValid()
      {
        //Arrange
        Guid id = Guid.NewGuid();
        ProviderAuthUpdateRequest request = new ProviderAuthUpdateRequest
      ...
      [Fact]
      public async Task Validate_ProviderAuthUpdateRequest_range_IsValid()
      {
        //Arrange
        Guid id = Guid.NewGuid();
      ...
      [Fact]
      public async Task Validate_ProviderAuthUpdateRequest_RangeWrongDomain()
      {
        //Arrange
        Guid id = Guid.NewGuid();
        string expected =
    ...
    public class UpdateProviderAsyncTests : ProviderServiceTests
    {
      ...
      public async Task Invalid_ProviderNotFound_Exception()
      {
        ...
        try
        {
          ...
          //Assert
          Assert.True(false, "ProviderNotFoundException expected");
        }
        ...
        {
          Assert.True(false,
            $"ProviderNotFoundException expected but got: {ex.Message}");
        }
      }
    }
    ...
    public class UpdateProviderLevelsAsyncTests : ProviderServiceTests
    {
      ...
      public async Task UpdateProviderLevelsAsync_ProviderLevels_Updated()
      {
        ...
        Entities.Provider provider = _context.Providers
          .Where(p => p.Id == ServiceFixture.PROVIDER_API_USER_ID)
          .SingleOrDefault();
    ...
    public class CreateTestReferralsAsyncTests : ProviderServiceTests
    {
      ...
      public async Task CreateTestReferralsAsync_FalseResponse()
      {
        ...
        // Act
        bool response = await _service.CreateTestReferralsAsync(1);
    ...
    public class GetRejectionReasonsAsyncTests : ProviderServiceTests
    {
      ...
      [Fact]
      public async Task ValidListReturned()
      {
        //Arrange
        var reason = new Business.Entities.ProviderRejectionReason
        {
        ...
        response.FirstOrDefault().Title.Should().Be("TestDescription");
        //Cleanup
      ...
      {
        //Arrange
        var reason1 = new Business.Entities.ProviderRejectionReason
        {
          ModifiedAt = DateTimeOffset.Now,
          IsActive = false,
          Description = "This is a test description 1",
          Title = "TestDescription1",
          ModifiedByUserId = Guid.Empty
        };
        var reason2 = new Business.Entities.ProviderRejectionReason
        {
          ModifiedAt = DateTimeOffset.Now,
          IsActive = true,
        ...
        //Cleanup
        _context.ProviderRejectionReasons.Remove(reason1);
        _context.ProviderRejectionReasons.Remove(reason2);
        await _context.SaveChangesAsync();
      }
    ...
    public class SetRejectionReasonsAsyncTests : ProviderServiceTests
    {
        ...
        : base(serviceFixture, testOutputHelper)
      {
        ...
        var entity = new Business.Entities.ProviderRejectionReason
        {
          ModifiedAt = DateTimeOffset.Now,
          IsActive = true,
          Description = "This is a test description",
      ...
      public async Task ValidNewReason()
      {
        ...
        //Act
        ProviderRejectionReason response =
          await _service.SetNewRejectionReasonsAsync(reason);
        //Assert
