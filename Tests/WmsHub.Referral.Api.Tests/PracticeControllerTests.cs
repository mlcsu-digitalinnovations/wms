  ...
  public class PracticeControllerTests : ServiceTestsBase, IDisposable
  {
    ...
    public class CreateAsync : PracticeControllerTests
    {
      ...
      public async Task Valid(
        string email, string name, string odsCode, string systemName)
      {
        // ARRANGE
      ...
      public static IEnumerable<object[]> GetValidPracticeCreationData()
      {
        List<object[]> validData = new List<object[]>();
        for (int i = 0; i < _validOdsCodeFirstChars.Count; i++)
        {
          validData.Add(new object[] {
            Generators.GenerateEmail(_random),
    ...
    public class UpdateAsync : PracticeControllerTests
    {
      ...
      public static IEnumerable<object[]> GetValidPracticeUpdateData()
      {
        List<object[]> validData = new List<object[]>();
        for (int i = 0; i < _validPracticeSystemNames.Length; i++)
        {
          validData.Add(new object[] {
            Generators.GenerateEmail(_random),
            Generators.GenerateName(_random, 10),
            _existingPractice.OdsCode,
            _validPracticeSystemNames[i]
          });
        }
        return validData;
      }
      ...
      string systemName = null)
    {
      ...
      {
        Email = email ?? Generators.GenerateEmail(_random),
        IsActive = isActive,
