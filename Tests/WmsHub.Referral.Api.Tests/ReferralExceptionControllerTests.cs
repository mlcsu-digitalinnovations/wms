  ...
  public class ReferralExceptionControllerTests : TestSetup
  {
    ...
    public class PostNhsNumberMismatch : ReferralExceptionControllerTests
    {
      ...
      public async Task Valid()
      {
        ...
        {
          NhsNumberAttachment = "9999999994",
    ...
    public class PutMissingAttachmentTests : ReferralExceptionControllerTests
    {
      ...
      public async Task ValidUpdate_Status_200()
      {
        ...
        ReferralMissingAttachmentPost request = new()
        {
          ServiceId = "123456",
          Ubrn = ubrn
        };
        ...
        // Act.
        IActionResult response = await _classToTest.PutMissingAttachment(request);

        // Assert.
        _mockReferralService.Verify();

        response.Should().NotBeNull().And.BeOfType<OkObjectResult>()
          .Subject.Value.Should().Be(referral.Object);
      }
      ...
      public async Task ReferralUpdateException_Test_Return_Status_500()
      {
        ...
        //Act
        var response = await _classToTest.PutMissingAttachment(request);
    ...
    public class PutInvalidAttachmentTests : ReferralExceptionControllerTests
    {
      ...
      public async Task ValidUpdate_Status_200()
      {
        ...
        {
          MostRecentAttachmentDate = DateTime.UtcNow,
        ...
        // Act.
        IActionResult response = await _classToTest.PutInvalidAttachment(request);
    ...
    public class PutNhsNumberMismatchTest : ReferralExceptionControllerTests
    {
      ...
      public async Task ValidUpdate_Status_200()
      {
        ...
        ReferralNhsNumberMismatchPost putMethod = new()
        {
          Ubrn = ubrn,
        ...
        // Act.
        IActionResult response = await _classToTest.PutNhsNumberMismatch(putMethod);
