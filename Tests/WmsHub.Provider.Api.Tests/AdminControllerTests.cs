...
namespace WmsHub.ProviderApi.Tests
{
  public class AdminControllerTests : TestSetup
  {
    ...
    {
      _classToTest = new AdminController(_mockProviderService.Object);
    ...
    public class AdminUserAllowed : AdminControllerTests
    {
      ...
      public async Task UserIsAdminGetReturnOk()
      {
        //Arrange
        int expected = 200;
        _mockProviderService.Setup(x => x.GetAllActiveProvidersAsync())
      ...
      public async Task UserIsAdminGetKeyUpdateReturnOk()
      {
        ...
        _mockProviderService.Setup(x => x.GetProviderAsync(_providerId))
          .Returns(Task.FromResult(mockResponse.Object));

        _mockProviderService.Setup(x => x.UpdateProviderKeyAsync
    ...
    public class GetKeyUpdate : AdminControllerTests
    {
      ...
      public async Task ProviderIsNull()
      {
        ...
        _mockProviderService.Setup(x => x.GetProviderAsync(It.IsAny<Guid>()))
    ...
    //      };
    //    Mock<ServiceUserUpdateTypeReasonResponse> mockResponse = new();
    ...
    //    ServiceUserUpdateTypeReasonRequest request =
    //      new ServiceUserUpdateTypeReasonRequest
    //      {
    //        Title = title,
    //        Description = expected
    //      };
    //    Mock<ServiceUserUpdateTypeReasonResponse> mockResponse = new();
    //    mockResponse.Setup(t => t.ResponseStatus).Returns(StatusType.Valid);
    //    _mockService.Setup(t => t.SetNewRejectionReasonAsync(request))
    //      .ReturnsAsync(mockResponse.Object);
