$apiKeyEnvVar = "WmsHub.ChatBot.Api.Service_ApiKey"
$emailPasswordEnvVar = "WmsHub.ChatBot.Api.Service_EmailPassword"
...
$subject = "WmsHub.ChatBot.Api.Service"
$body = "The WmsHub.ChatBot.Api.Service"
$mailPriority = 0

$app = "WmsHub.ChatBot.Api.Service.Daily"
...
try
{
    ...
    $Params = @{
     "URI"     = "https://api-chatbot.wmp.nhs.uk/referralcall"
     "Method"  = 'GET'
     "Headers" = @{
