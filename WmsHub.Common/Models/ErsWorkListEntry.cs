...
namespace WmsHub.Common.Models
{
  public class ErsWorkListEntry
  {
    ...
    private const string EXTENSION_URL_PATIENT = "patient";
    private const string EXTENSION_CRI_UPDATED = "clinicalInfoLastUpdated";
    private const string EXTENSION_CRI_SUBMITTED = "clinicalInfoFirstSubmitted";
    ...
    public DateTimeOffset? ClinicalInfoLastUpdated => Extension
