...
public class AdminController : BaseController
{
  ...
  public async Task<IActionResult> GetReferralStatusReasons()
  {
    ReferralStatusReason[] referralStatusReasons = await Service
      .GetReferralStatusReasonsAsync();

    return Ok(referralStatusReasons);
  }
